...
export default function LeftPanel({
    ...
    //         )
    //     );
    const updateContact = (id, prefix, value) => {
        setTexts(prev =>
            prev.map(item =>
                item.id === id
                    ? {
        ...
        <div className="leftpanel-container">
            ...
            <div className="leftpanel-icons">
                ...
                <div className="icon-item">
                    ...
                    {isMobile && <span className="icon-label">Templates</span>}
                </div>
            ...
            <div className={`leftpanel-full ${activeSection ? "active" : ""}`}>
                ...
                {show("contact") && (
                    <>
                        ...
                        <input
                            className={inputClass}
                            value={texts.find(item => item.id === 4)?.text.replace("📞 ", "") || ""}
                            onChange={e => updateContact(4, "📞", e.target.value)}
                        />
                        ...
                        <input
                            className={inputClass}
                            value={texts.find(item => item.id === 5)?.text.replace("✉ ", "") || ""}
                            onChange={e => updateContact(5, "✉", e.target.value)}
                        />
                        ...
                        <input
                            className={inputClass}
                            value={texts.find(item => item.id === 6)?.text.replace("📍 ", "") || ""}
                            onChange={e => updateContact(6, "📍", e.target.value)}
                        />
                    </>
                )}
                    ...
                    <>
                        ...
                        <label className="flex items-center gap-2 py-2 px-3 bg-[#0b1f33] text-white rounded cursor-pointer shadow">
                            ...
                            <input
                                ...
                                //             // Cover mode (same logic as Canva)
